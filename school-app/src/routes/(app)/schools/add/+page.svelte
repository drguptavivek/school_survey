...
<div class="max-w-4xl space-y-6">
	<div>
		...
		<h1 class="text-2xl font-bold text-slate-900">Add school</h1>
		<p class="text-sm text-slate-600">
			Create a new school record with complete school information. Code is auto-generated and cannot be edited.
		</p>
	</div>
