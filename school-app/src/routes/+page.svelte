		...
		<section class="grid gap-10 lg:grid-cols-[1.1fr,0.9fr] lg:items-center">
			<div class="space-y-6">
				...
				<div class="flex flex-wrap items-center gap-3">
					<a
						href={ctaHref}
						class="rounded-full bg-sky-700 px-5 py-2.5 text-sm font-semibold text-white shadow-md transition hover:-translate-y-0.5 hover:bg-sky-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600"
					>
						{ctaLabel}
					</a>
					<a
			...
			<div class="relative">
				<div class="absolute inset-0 -z-10 scale-[1.02] rounded-[28px] bg-gradient-to-br from-sky-100 via-white to-amber-50 blur-2xl"></div>
			...
			<div class="grid gap-8 lg:grid-cols-[2fr,1fr] lg:items-center">
				<div class="space-y-4">
					...
					<div class="flex flex-wrap gap-3">
						<a
							href={ctaHref}
							class="rounded-full bg-white px-5 py-2.5 text-sm font-semibold text-slate-900 shadow-lg transition hover:-translate-y-0.5 hover:bg-slate-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
						>
							{ctaLabel}
						</a>
						<a
