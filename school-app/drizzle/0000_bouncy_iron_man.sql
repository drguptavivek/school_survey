...
CREATE SEQUENCE IF NOT EXISTS "district_code_seq"
    INCREMENT BY 1
    MINVALUE 101
    START WITH 101;
...
CREATE TABLE "districts" (
	...
	"code" varchar(50) DEFAULT nextval('district_code_seq') NOT NULL,
...
CREATE TABLE "partners" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"name" varchar(255) NOT NULL,
	"code" varchar(50) DEFAULT nextval('partner_code_seq') NOT NULL,
